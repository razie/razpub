...
import com.razie.pub.base.data.HttpUtils;
    ...
    public class AttrAccessImpl implements AttrAccess {
        // lazy
      ...
      public void setAttr(Object... pairs) {
            ...
            } else if (pairs != null && pairs.length == 1 && pairs[0] instanceof AttrAccessImpl) {
                AttrAccessImpl m = (AttrAccessImpl) pairs[0];
        ...
        /** TODO implement */
        public static AttrAccessImpl fromJsonString(String s) {
            try {
        ...
        /** TODO implement */
        public static AttrAccessImpl fromJson(JSONObject o) {
            AttrAccessImpl a = new AttrAccessImpl();
        ...
        /** TODO implement */
        public final static AttrAccessImpl reflect(Object o) {
