...
import com.razie.pub.hframe.draw.DrawStream.Element.State;
...
public interface StreamableContainer extends DrawAccumulator {
    public DrawStream.Element.State getState();
    ...
    public abstract static class Impl implements StreamableContainer {
        DrawStream.Element.State state         = DrawStream.Element.State.WAITING;
        ...
        public void close() {
            ...
            this.state = DrawStream.Element.State.CLOSED;
        }
