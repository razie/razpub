 ...
 * contexts, hardcode mappings etc. This class may go away and be replaced with the jdk1.6 scriptables.
 * 
...
public interface ScriptContext extends AttrAccess {
    ...
    public class Impl extends AttrAccess.Impl implements ScriptContext {
        public Impl() {
        };
