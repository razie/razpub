 ...
 * @version $Id$
 */
abstract public class AgentJava {
   ...
   protected final static Log        logger      = Log.factory.create("agent", Agent.class.getSimpleName());

   /** initialize agent with given info */
   public AgentJava(AgentHandle me, AgentCloud homeCloud) {
      this.me = me;
   ...
   public Agent me () { return (Agent)this; }
   /**
